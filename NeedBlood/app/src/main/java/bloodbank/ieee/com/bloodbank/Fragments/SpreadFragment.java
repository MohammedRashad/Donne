    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        shareGithub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //TODO Add the test
                share("#NeedBlood is an open-source blood donation network, you can view the source code here : ...................");
        ...
        shareApp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                share("#NeedBlood is an open-source blood donation network, you can get it here : ...................");
